        ...
        >
          ...
          <div>
            ...
            <div class="grid grid-flow-col auto-cols-max">
              ...
              <div class="self-center text-center font-bold text-white px-2 border-4 border-red-900 bg-red-600 rounded-xl" @click="decrementHp(monster, -3)">3</div>
              <div class="self-center text-center font-bold text-white px-2 border-4 border-red-900 bg-red-600 rounded-xl" @click="decrementHp(monster, -2)">2</div>
              <div class="self-center text-center font-bold text-white px-2 border-4 border-red-900 bg-red-600 rounded-xl" @click="decrementHp(monster, -1)">1</div>
              <div class="self-center text-center font-bold text-white px-2 border-4 border-green-900 bg-green-600 rounded-xl" @click="decrementHp(monster, 1)">1</div>
